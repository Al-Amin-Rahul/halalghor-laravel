...
@section('body')
    <div class="container-fluid">
        <h2 class="text-center mt-5">Popular Product</h2>
        <div class="row">
            <div class="col-md-10 offset-md-1">
                <a href="{{ route("popular_product.show") }}"><h5 class="float-right border-dark mt-2 p-1" style="box-sizing: border-box;border: 1px solid darkgreen;color: black">See All</h5></a></a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-10 offset-md-1">
